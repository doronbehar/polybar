...
#define APP_VERSION "3.3.1-38-gf3d3e92"
#ifndef APP_VERSION
#define APP_VERSION GIT_TAG
#endif
#define APP_VERSION_NAMESPACE v3_3_1_38_gf3d3e92
#ifndef APP_VERSION_NAMESPACE
#define APP_VERSION_NAMESPACE GIT_TAG_NAMESPACE
#endif
#define BASE_PATH "/var/code/doron/polybar"

#define ENABLE_ALSA 1
#define ENABLE_MPD 1
#define ENABLE_NETWORK 1
#define WITH_LIBNL 1
#define WIRELESS_LIB "libnl"
#define ENABLE_I3 0
...
const auto print_build_info = [](bool extended = false) {
  ...
  if (extended) {
    ...
    printf("Compiler: /usr/lib/ccache/bin/c++\n");
    printf("Compiler flags:  -Wall -Wextra -Werror -Wno-noexcept-type -pedantic -pedantic-errors\n");
    printf("Linker flags: \n");
  }
};
// clang-format on
